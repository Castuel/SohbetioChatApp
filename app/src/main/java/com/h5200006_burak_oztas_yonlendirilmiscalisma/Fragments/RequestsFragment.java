...
public class RequestsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        requestsListRecyclerView = requestsFragmentView.findViewById(R.id.chat_requests_list);
        requestsListRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
                                        ...
                                        usersRef.child(list_user_id).addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                ...
                                                if (snapshot.hasChild("userImage")) {
                                                    ...
                                                    final String requestProfileImage = snapshot.child("userImage").getValue().toString();
                                                ...
                                                holder.itemView.setOnClickListener(new View.OnClickListener() {
                                                    ...
                                                    public void onClick(View view) {
                                                        ...
                                                        builder.setTitle(requestUserName + " sent u chat request");
    ...
    public static class requestsViewHolder extends RecyclerView.ViewHolder {
        ...
        public requestsViewHolder(@NonNull View itemView) {
            ...
            acceptRequestButton = itemView.findViewById(R.id.request_accept_btn);
            cancelRequestButton = itemView.findViewById(R.id.request_cancel_btn);
        }
